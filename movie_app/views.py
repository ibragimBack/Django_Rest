...
class DirectorDetailAPIView(RetrieveUpdateDestroyAPIView):
    ...
    def update(self, request, *args, **kwargs):
        ...
        serializer = DirectorValidateSerializer(instance, data=request.data)
        serializer.is_valid(raise_exception=True)
        instance.name = request.data.get('name')
        instance.save()
        return Response(data=DirectorDetailSerializers(instance).data, status=status.HTTP_200_OK)
...
class MovieDetailAPIView(RetrieveUpdateDestroyAPIView):
    ...
    def update(self, request, *args, **kwargs):
        instance = self.get_object()
        serializer = MovieValidateSerializer(instance, data=request.data)
        serializer.is_valid(raise_exception=True)
        instance.title = request.data.get('title')
        instance.description = request.data.get('description')
        instance.duration = request.data.get('duration')
        instance.director_id = request.data.get('director_id')
        instance.save()
        return Response(data=MovieDetailSerializers(instance).data, status=status.HTTP_200_OK)
...
class ReviewDetailAPIViews(RetrieveUpdateDestroyAPIView):
    queryset = Review.objects.all()
    serializer_class = ReviewSerializers
    lookup_field = 'id'
    ...
    def update(self, request, *args, **kwargs):
        ...
        instance.movie_id = request.data.get('movie_id')
        instance.star = request.data.get('star')
        instance.save()
        return Response(data=ReviewDetailSerializers(instance).data,
                        status=status.HTTP_201_CREATED)
